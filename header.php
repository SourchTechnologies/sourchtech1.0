  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        ...
        <a href="index.php"><img src="icon.png" alt="" class="img-fluid" ></a>
      </div>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Better digital experience with Sourch Technologies</h1>
          <h2>Take your company to the next level and
          grow your Business with our B2B Marketing
          </h2>
          <div>
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/social.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
